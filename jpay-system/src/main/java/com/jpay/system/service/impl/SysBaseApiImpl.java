...
import com.jpay.common.constant.CacheConstant;
import com.jpay.common.constant.CommonConstant;
import com.jpay.common.constant.DataBaseConstant;
import com.jpay.common.exception.JpayBootException;
import com.jpay.common.system.api.ISysBaseAPI;
import com.jpay.common.system.vo.ComboModel;
import com.jpay.common.system.vo.DictModel;
import com.jpay.common.system.vo.LoginUser;
import com.jpay.common.system.vo.SysDepartModel;
import com.jpay.common.util.IPUtils;
import com.jpay.common.util.SpringContextUtils;
import com.jpay.common.util.oConvertUtils;
import com.jpay.modules.message.websocket.WebSocket;
import com.jpay.system.mapper.*;
import com.jpay.system.pojo.po.*;
import com.jpay.system.service.ISysDepartService;
import com.jpay.system.service.ISysDictService;
		...
		if("".equals(DB_TYPE)) {
			...
			try {
				...
				if(dbType.indexOf("mysql")>=0) {
					...
					throw new JpayBootException("数据库类型:["+dbType+"]不识别!");
				}
			} catch (Exception e) {
