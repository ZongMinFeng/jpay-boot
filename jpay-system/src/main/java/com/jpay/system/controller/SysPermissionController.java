...
import com.jpay.system.model.SysPermissionTree;
import com.jpay.system.model.TreeModel;
import com.jpay.system.pojo.po.SysPermission;
import com.jpay.system.pojo.po.SysPermissionDataRule;
import com.jpay.system.pojo.po.SysRolePermission;
import com.jpay.system.service.ISysPermissionDataRuleService;
import com.jpay.system.service.ISysPermissionService;
import com.jpay.system.service.ISysRolePermissionService;
import com.jpay.system.util.PermissionDataUtil;
...
//	}
	...
	public Result<?> getUserPermissionByToken(@RequestParam(name = "token", required = true) String token) {
		...
		try {
			...
			log.info("menujsonArray:"+ menujsonArray);//debug
