package com.jpay.common.system.util;
...
import com.jpay.common.system.vo.SysUserCacheInfo;
...
public class JwtUtil {
	 ...
	 * @param request
	 * @return
	 * @throws JpayBootException
	 */
	public static String getUserNameByToken(HttpServletRequest request) throws JpayBootException {
		String accessToken = request.getHeader("X-Access-Token");
		String username = getUsername(accessToken);
		if (oConvertUtils.isEmpty(username)) {
			throw new JpayBootException("未获取到用户");
		}
		return username;
	}
